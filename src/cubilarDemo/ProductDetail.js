...
const ProductDetail = (props) => {
  ...
  return (
    <View style={{ backgroundColor: AppColors.white, flex: 1, paddingHorizontal: wp('4'), paddingTop: hp('4') }}>
      ...
      {/* <View style={{flex:1,height:hp('60'),}}> */}
      <ImageBackground source={item.image} imageStyle={{ width: wp('93'), backgroundColor: AppColors.grey, height: hp('40'), borderTopRightRadius: wp('7'), borderTopLeftRadius: wp('7') }} >
